...
Şu anda **Makine Öğrenmesi (ML)**, **Derin Öğrenme (DL)** ve **Veri Bilimi** alanlarında kendimi geliştiriyorum. Veriden anlamlı sonuçlar çıkarmayı ve akıllı sistemler tasarlamayı seviyorum.

---

### 🧠 İlgi Alanlarım ve Çalıştığım Konular
* **Makine Öğrenmesi:** Regresyon Modelleri, Karar Ağaçları, Ensemble Methods
* **Bilgisayarlı Görü:** OpenCV, MediaPipe, Nesne Tespiti
* **Doğal Dil İşleme (NLP):** Metin Madenciliği, Sentiment Analysis
* **Veri Bilimi:** Veri Ön İşleme, EDA (Keşifçi Veri Analizi)
